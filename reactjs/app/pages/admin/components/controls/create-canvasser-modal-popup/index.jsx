...
componentWillMount(){
    ...
    else if(this.props.data.teams){
       this.props.data.teams.length>0?this.props.model.selectedTeamForConvesser = {id:this.props.data.teams[0].id, label:this.props.data.teams[0].label} : this.props.model.selectedTeamForConvesser =null;
    }
    this.props.model.isTeamChanged = false;   
}

  componentDidMount(){
    this.firstName.focus();    
     this.props.model.searchedTeams&&this.props.model.searchedTeams.length>0? (this.props.model.searchedTeams[0].id != 0? this.props.model.searchedTeams.splice(0,0,{id:0,label:'select',routes:[],users:[]}) : null): null; 
    //  this.props.model.
  }
 ...
 */
  ...
  OnConvesserTypeChanged(type){
   let value = {id: type.id, type:type.type}; 
   this.props.dispatch(Action.getAction(adminActionTypes.SET_CONVESSER_TYPE, {value: value}));   
  } 
  /**
  ...
  OnTeamChanged(team){
   ...
   let value = {id: team.id, label:team.label}; 
   if(value.id!=0)
   this.props.model.isTeamChanged =true;
   else
   this.props.model.isTeamChanged =false;
   this.props.dispatch(Action.getAction(adminActionTypes.SET_SELECTED_TEAM_FOR_CONVESSER, {value: value}));   
  } 
                ...
                this
                  ...
                  .onAddUpdateDeleteCanvasser({
                    ...
                    email: this
                      ...
                      type : this.props.model.selectedConvesserType? this.props.model.selectedConvesserType.id : null,
                      isTeamChanged : this.props.model.isTeamChanged,
                  });
              }
            }              
            }
        ...
        <Modal
          ...
          <table className="convasser-info-dialog">
            <tbody>
              <tr className="profile-first-row">
                <td className="first-column">
                  ...
                  <input
                    ...
                    defaultValue={this.props.data != null ? this.props.data.firstName : ''}                    
                ...
                <td className="sec-column">
                  ...
                  <input
                    ...
                    defaultValue={this.props.data != null ? this.props.data.lastName : ''}
                    onKeyUp= {(e)=>this.onAddUpdateCanvassser(e)}
                    />
                </td>
              </tr>
              ...
              <tr>
                <td colSpan="2">
                  ...
                  <input
                    ...
                    defaultValue={this.props.data != null ? (!this.props.data.email ? this.props.data.name : this.props.data.email) : ''}
                    onKeyUp= {(e)=>this.onAddUpdateCanvassser(e)}
                   />
                </td>
              ...
              <tr>
              <td colSpan="1" className="teamtype">
                  <label>Team</label>
                 {
                     
                    <Select value={this.props.model.selectedTeamForConvesser} valueKey="id" labelKey="label" searchable={false} clearable={false}
                  ...
                  <td colSpan="1" className="teamtype">
                  <label>Type</label>
                 { <Select value={this.props.model.selectedConvesserType} valueKey="id" labelKey="type" searchable={false} clearable={false}
                                                menuRenderer={menuRenderer} disabled={false}
            ...
            {action == Constants.action.update
              ? (
                <button
                  ...
                  teams:this.props.data && this.props.data.teams ? this.props.data.teams :[],
                  teamId : this.props.model.selectedTeamForConvesser?this.props.model.selectedTeamForConvesser.id:null,
                  teamName : this.props.model.selectedTeamForConvesser?this.props.model.selectedTeamForConvesser.label:null,
                  type : this.props.model.selectedConvesserType? this.props.model.selectedConvesserType.id : null,
                  isTeamChanged : this.props.model.isTeamChanged,
