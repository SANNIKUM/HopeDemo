...
class TeamWiseStatsComponent extends React.Component {
     ...
     */
    render() {
        let teamSurveys = this.props.model.middleFilterModel.dataViewData.teamsSurveys;
                                            ...
                                            this.getTeams(site.siteId).map((team, teamindex) =>
                                                ...
                                                <div className="data-list-routes-item clearfix" key={"site-team-key-" + teamindex} style={{ color: team.color,fontSize:'9px' }}>
                                                    ...
                                                    <div className="data-list-submitted-surveys col-xs-1 p-0">
                                                        {(teamSurveys && teamSurveys["team_" + team.teamId + "_b_" + team.boroughId] != "0") ? teamSurveys["team_" + team.teamId + "_b_" + team.boroughId] : ''}
                                                    </div>
                                                </div>
                                            )
                                        }
