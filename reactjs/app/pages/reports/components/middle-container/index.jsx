                ...
                <div className={'panel panel-inverse ' + (model.panelProperties.panelExpanded ? " panel-expand " : "")}  >
                    <div className="panel-heading">
                        <ToolBoxControl dataModel={model.panelProperties}
                            ...
                            onReload={() => {
                                this.props.dispatch(Action.getAction(reportsActionTypes.SET_PANEL_RELOAD_REPORTS_REFRESH, true));
                            } }
                            onCollapse={() => {
                            ...
                            />
                        <h4 className="panel-title"><panel>Download Surveys</panel></h4>
                    </div>
                    <div className={"panel-body " + (model.panelProperties.panelExpanded ? " custom-scroll " : '') + (model.panelProperties.panelCollapsed ? ' height-0 ' : '')}>
                        ...
                        <div className="reports-content">      
                            {this.props.children}                     
                            {model.panelProperties.panelReload ? <div className="panel-loader"><span className="spinner-small"></span></div> : ''}
                        </div>
